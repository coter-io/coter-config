...
```
Agent(
  prompt="Read /Users/majskiy/Documents/projects/coter/coter-config/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/majskiy/Documents/projects/coter/coter-config/.codex/gsd-core/templates/SECURITY.md`
