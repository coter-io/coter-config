...
```
Agent(
  prompt="Read /Users/majskiy/Documents/projects/coter/coter-config/.cursor/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/majskiy/Documents/projects/coter/coter-config/.cursor/gsd-core/templates/SECURITY.md`
