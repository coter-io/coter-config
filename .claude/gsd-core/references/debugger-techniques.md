...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/majskiy/Documents/projects/coter/coter-config/.claude
                  → checks /Users/majskiy/Documents/projects/coter/coter-config/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/majskiy/Documents/projects/coter/coter-config/.claude/gsd-core
                  → writes to /Users/majskiy/Documents/projects/coter/coter-config/.claude/gsd-core/hooks/
