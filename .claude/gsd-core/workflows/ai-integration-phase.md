...
<required_reading>
@/Users/majskiy/Documents/projects/coter/coter-config/.claude/gsd-core/references/ai-frameworks.md
@/Users/majskiy/Documents/projects/coter/coter-config/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/majskiy/Documents/projects/coter/coter-config/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/majskiy/Documents/projects/coter/coter-config/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/majskiy/Documents/projects/coter/coter-config/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/majskiy/Documents/projects/coter/coter-config/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/majskiy/Documents/projects/coter/coter-config/.claude/agents/gsd-eval-planner.md for instructions.
