...
**Verification depth scales with `asvs_level`** (see @/Users/majskiy/Documents/projects/coter/coter-config/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
